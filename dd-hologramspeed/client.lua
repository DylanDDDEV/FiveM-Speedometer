...
local currentTheme   = GetConvar("ddot_defaultTheme", "default")
...
RegisterCommand("ddot", function(_, args)	
	if #args == 0 then
		ToggleDisplay()
	else
		CommandHandler(args)
...
TriggerEvent('chat:addSuggestion', '/ddot', 'Toggle the holographic speedometer', {
    { name = "command",  help = "Allow command: theme, offset, rotate" },
})

RegisterKeyMapping("ddot", "Toggle Holographic Speedometer", "keyboard", "grave") -- default: `
